...
function processOperatorButtonInput(inputStr) {  // TODO: Include case: Operator entered after '=' button clicked
  ...
  if (newOperatorFunc) {
    if (inputObj.operandA === "" && inputObj.operator === null) {
      ...
      throw new Error(
        `ERROR in processOperatorButtonInput(argument = ${inputStr})`
      );
    }
  } else {
